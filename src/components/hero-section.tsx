  ...
  return (
    <section className="relative min-h-[70vh] sm:min-h-[80vh] lg:h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-6 text-balance leading-tight text-red-400">
          {"Dive Into Adventure"}
        </h1>
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-balance opacity-90 leading-relaxed text-red-400">
